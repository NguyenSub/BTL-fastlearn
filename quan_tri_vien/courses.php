...
session_start();
require '../php/db.php';
// Lấy danh sách giảng viên (chỉ dành cho admin)
$teachers = [];
if ($_SESSION['role'] === 'admin') {
    $stmt = $pdo->prepare("SELECT id, fullname FROM users WHERE role = 'teacher'");
    $stmt->execute();
...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/quan_tri_vien_courses.css">
...
<body>
    ...
    <nav>
        <ul class="row">
            <li class="first-span active"><a href="courses.php"><span
                        class=" material-symbols-outlined">folder_special</span></a></li>
