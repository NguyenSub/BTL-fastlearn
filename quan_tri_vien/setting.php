...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/quan_tri_vien_setting.css">
    ...
    document.documentElement.style.setProperty('--cl-dark-2', lightColor2);
        ...
        checkbox.addEventListener('change', function() {
            if (this.checked) {
                ...
                document.documentElement.style.setProperty('--cl-light-bg', darkColor1);
                ...
                document.documentElement.style.setProperty('--cl-light-bg', 'while');
                document.documentElement.style.setProperty('--cl-light-box-shadow', 'rgb(255 255 255 / 10%)');
